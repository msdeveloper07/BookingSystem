...
(function($) {
  ...
  $.fn.pekeUpload = function(options){
    ...
    var defaults = {
      onSubmit:       false,
      btnText:        "Add Itinerary Image",
      url:        "upload.php",
      theme:        "custom",
      field:        "file",
      allowed_number_of_uploads:        6,
      data:         null,
      multi:        true,
      showFilename:       true,
      showPercent:        true,
    ...
    this.each(function() {
      ...
      var html = '<a href="javascript:void(0)" class="btn btn-flat btn-upload" style="display:inline;"> <span class="icon-upload icon-white"></span> '+options.btnText+'</a><div class="pekecontainer"></div>';
      }
