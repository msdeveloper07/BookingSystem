...
!function(a) {
    ...
    b.prototype = {constructor: b, add: function(b, c) {
            ...
            if (!(d.options.maxTags && d.itemsArray.length >= d.options.maxTags || b !== !1 && !b)) {
                if ("string" == typeof b && d.options.trimValue && (b = a.trim(b)), "object" == typeof b && !d.objectItems)
            ...
            if (d.objectItems && (b = "object" == typeof b ? a.grep(d.itemsArray, function(a) {
                ...
                if (d.$element.trigger(e), e.cancel)
                    return;
        ...
        return this.each(function() {
            ...
            if (f)
                ...
                f = new b(this, c), a(this).data("tagsinput", f), e.push(f), "SELECT" === this.tagName && a("option", a(this)).attr("selected", "selected"), a(this).val(a(this).val())
