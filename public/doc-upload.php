<?php
 ...
 $targetFolder = 'attachments/'; // Relative to the root
...
if (!empty($_FILES)) 
	...
	$targetFile = rtrim($targetPath,'/') . '/' . $target_file_name  ;
        ...
        $fileTypes = array('jpg','jpeg','gif','png','doc','docx','pdf','xls','xlsx','zip','rar','ppt','pptx');
	...
	if (in_array($fileParts['extension'],$fileTypes)) {
		move_uploaded_file($tempFile,$targetFile);
	        ...
	        $files=array();
                ...
                $files['logo_image'] = "/images/attachment.png";
