<?php
 ...
 $targetFolder = 'images/profile_pic/'; // Relative to the root
	...
	if (in_array($fileParts['extension'],$fileTypes)) {
		move_uploaded_file($tempFile,$targetFile);
	        ...
	        $files=array();
                ...
                $files['logo_image'] = "/images/itinerary/$target_file_name";
...
function random_string($type="string",$random_string_length='5')
{
