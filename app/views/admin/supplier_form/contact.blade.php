                    ...
                    <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="location_id" id="location_id">
                                    ...
                                    <option {{$supplier->supplier_location_id==$l->location_id?'selected="selected"':''}} value="{{$l->location_id}}">{{$l->location_name}} </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="latitude" name="latitude" value="{{Input::old('latitude',$address->latitude)}}" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="InputTitle">Longitude</label>
                                <input type="text" id="longitude" name="longitude" value="{{Input::old('longitude',$address->longitude)}}" class="form-control">
                            </div>
                        </div>
                    </div>
