        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li ><a href="/supplier/contacts/{{$supplier->supplier_id}}">Contact</a></li>
                 ...
                 <li class="active"><a href="/Commission/{{$supplier->supplier_id}}">Commission</a></li>
        </div>   
    </div>
...
<div class="row">
    <form  role="form" action='/commission_store/{{$supplier->supplier_id}}' name='commission_form' id='commission_form' method="post">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="citem" name="citem" value="" placeholder="enter commission in %">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="radio" id="paypal" name="paypal" value="1" checked>Pay Pal </br>
                              
                               <input type="radio" id="paypal" name="paypal" value="2">Credit Card
                            </div>
                        </div>
                    </div>
