        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li><a href="/package/gallery/{{$package->package_id}}">Gallery</a></li>
                      <li><a href="/package/suppliers/{{$package->package_id}}">supplier</a></li>
                <li class="active"><a href="/package/items/{{$package->package_id}}">Items</a></li>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                          ...
                                          <select class="form-control" id="supplier_type_id_{{$i}}" onchange="supplierTypeSuppliers({{$package->package_id}}, this.value, {{$i}})" name="supplier_type[]" >
                                     ...
                                     <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="supplier_id_{{$i}}" onchange="supplierItems({{$package->package_id}}, this.value, {{$i}})" name="supplier_id[]" >
                                                        <option value="">Select Suppliers</option>
                                                         <?php
                                                         $package_suppliers = PackageSupplier::where('package_id',$package->package_id)->where('supplier_type_parent_id',$item->supplier_type_id)->get(); ?>
...
<div id="add_new_template" style="display:none">
  ...
  <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label for="InputTitle">Supplier Type</label>
                    <select class="form-control" id="supplier_type_id_index" onchange="supplierTypeSuppliers({{$package->package_id}}, this.value, 'index')" name="supplier_type[]" >
                              <option value="">Select Supplier Type</option>
                                               @foreach($packagesuppliers as $p)
                                             <?php $supplier_type = SupplierType::where('supplier_type_id',$p->supplier_type_parent_id)->get(); ?>
                                                @foreach($supplier_type as $s)
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <label for="InputTitle">Supplier Name</label>
                    <select class="form-control" id="supplier_id_index" onchange="supplierItems({{$package->package_id}}, this.value, 'index')" name="supplier_id[]" >
                              <option value="">Select Suppliers</option>
