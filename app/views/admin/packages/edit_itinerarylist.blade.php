...
<div class="row">
        ...
        <form  role="form" action='/package/items/{{$package->package_id}}' name='package_form' id='package_form' method="post">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                        ...
                        @if(isset($package_itinerary)&&($package_itinerary->package_itinerary_id == $l->package_itinerary_id))
                        <div class="row">
                            <div class="col-md-8">
                           <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            @endif
                             ...
                             <div class="col-md-12">
                                ...
                                <?php $itinerary_image= PackageItineraryImage::where('package_itinerary_id',$package_itinerary->package_itinerary_id)->where('days',$l->days)->get(); ?>
                                <p>@foreach($itinerary_image as $i)
                        
                                <img src="<?php echo url().'/images/itinerary/'.$i->image; ?>"   height="100px">
                                 <a href="/package/itinerary/remove/image/{{$i->package_itinerary_image_id}}" title="Remove" style="    vertical-align: bottom; display: inline-block; margin-left: -20px;"><i class="fa fa-times-circle fa-lg text-danger"></i></a>
                                @endforeach</p>
                             </div></div>
                        <div class="col-md-4">
                            <a href="/package/itinerary/edit/{{$l->package_id}}/{{$l->package_itinerary_id}}"><i class="fa fa-pencil-square fa-lg"></i>&nbsp;Edit</a>&nbsp;&nbsp;
                            <a href="/package/itinerary/remove/{{$l->package_itinerary_id}}" title="Edit"><i class="fa fa-times fa-lg"></i>&nbsp;Remove</a>
                        </div>
    ...
    <div class="col-md-4">
        ...
        <div class="row">
            <form  role="form" action='/package/updateItinerary' name='itinerary_form' id='itinerary_form' method="post">
                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                <input type="hidden" name="package_id" value="{{$package->package_id}}">
                <input type="hidden" name="package_itinerary_id" value="{{$package_itinerary->package_itinerary_id}}">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Enter Itinerary Title" id="itinerary_title" name="itinerary_title" class="form-control required" value="{{isset($package_itinerary)?$package_itinerary->itinerary_title:''}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="day" id="day" class="form-control">
                                                <?php for($o=1;$o<=$day;$o++){?>
                                                <option {{((isset($package_itinerary))&&($package_itinerary->days==$o)?'selected="selected"':'')}} value="{{$o}}">{{$o}}</option>
                                                <?php } ?>
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select id="thingstodo" name="thingstodo[]" class="form-control">
                                                    ...
                                                    <option {{isset($package_itinerary_thingstodo)&& $package_itinerary_thingstodo[$co-1]==$t->thing_todo_id?'selected="selected"':''}} value="{{$t->thing_todo_id}}">{{$t->thing_todo}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="extra_note" name="extra_note" value="">{{isset($package_itinerary)?$package_itinerary->extra_notes:''}} </textarea>
                                    </div>
                                </div>
                            </div>
