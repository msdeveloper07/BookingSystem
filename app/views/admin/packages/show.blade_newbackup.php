...
<div class="container" style="margin-top: 40px;">
      <div class="box-header">
                    ...
                    <a href='/bookings/{{$package->package_id}}/preview' target="_blank" class='btn btn-info' style="float:right;">Preview Invoice</a> &nbsp;
                    <a href='/bookings/{{$package->package_id}}/invoice/'  class='btn btn-success' style="float:right;">Create Invoice</a>
                </div><!-- /.box-header -->
    	<div class="row">
