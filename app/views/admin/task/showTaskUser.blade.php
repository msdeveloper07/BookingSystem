     ...
     <tbody>
       ...
       <tr>
           ...
           <td  data-title="Task Name">
               <a href="/staffnewTaskComment/{{$l->task_id}}" title="Comment">
           ...
           <td>
              <a href="/staffnewTaskComment/{{$l->task_id}}" title="Comment"><i class="fa fa-comment"></i>&nbsp;Comment({{TaskComment::where('task_id',$l->task_id)->get()->count()}})</a>
