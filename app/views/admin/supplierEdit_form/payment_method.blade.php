                        ...
                        <div class="col-md-12">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="active"><a href="/payment_method_edit/{{$supplier->supplier_id}}">Payment Method</a></li>
...
<div class="row">
    <form  role="form" action='/payment_method_update/{{$supplier->supplier_id}}' name='supplier_type_form' id='supplier_type_form' method="post">
