                     ...
                     <?php $airline_feature = AirlineFeature::where('airline_id',$airline->airline_id)->pluck('supplier_type_item_id');   ?>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="cost" name="property[{{$s->supplier_type_item_id}}][{{$j}}][cost]" value="{{isset($f->cost)?$f->cost:''}}" /> Cost
                                ...
                                <input type="checkbox" class="" {{$v==$f->name?'checked="checked"':''}}    id="airline_name" name="property[{{$s->supplier_type_item_id}}][{{$k}}][name]" class="form-inline"  value="{{$v}}">&nbsp; {{$v}}</input>
                                 </div>
                                  <div class='col-md-4'>
                                &nbsp; &nbsp;  <input type="text" class="form-inline cost" name="property[{{$s->supplier_type_item_id}}][{{$k}}][cost]" value="{{isset($f->cost)?$f->cost:''}}"  > Cost  </input>
