                      ...
                      <?php $hotel_feature = HotelFeature::where('hotel_id',$hotel->hotel_id)->pluck('supplier_type_item_id');   ?>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="property[{{$s->supplier_type_item_id}}][{{$j}}][cost]" class="cost" value="{{isset($f->cost)?$f->cost:''}}" /> Cost
                               ...
                               @if($f->name == $v)
                                 <input type="checkbox" class="" {{$v==$f->name?'checked="checked"':''}} id="hotel_name" name="property[{{$s->supplier_type_item_id}}][{{$k}}][name]" class="form-inline"  value="{{$v}}">&nbsp; {{$v}}</input>
                                 </div>
                                 <div class='col-md-4'>
                                   
                                 &nbsp; &nbsp; <input type="text" class="cost" class="form-inline" name="property[{{$s->supplier_type_item_id}}][{{$k}}][cost]" value="{{isset($f->cost)?$f->cost:''}}"  > Cost  </input>
