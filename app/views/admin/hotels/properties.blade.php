...
<div class="row">
    <form  role="form" action='/hotel/saveproperties/{{$hotel->hotel_id}}' name='user_form' id='user_form' method="post">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="property[{{$s->supplier_type_item_id}}][{{$j}}][cost]" class="cost" value="" /> Cost 
