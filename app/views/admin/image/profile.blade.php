                ...
                <div class="box-body">
                    ...
                    <div class="col-md-4">
                         ...
                         <input type="text" placeholder="Full name" id="name" name="name" class="form-control required" readonly="" value="{{$user->name}}">
                            ...
                            <img src="<?php echo url().'/images/profile_pic/'.$preet; ?>" id="profile_pic" height="150px" width="150px" class="">
                        </div>
						<div id="prev_upload">
                                     <input type="hidden"  name="profile_pic">
                                     </div>
                                    <div class="row">                 
                                     <div class="col-md-11"><input type="file" id="upload-button" name="file" /></div>
                                    </div>
                    </div>
