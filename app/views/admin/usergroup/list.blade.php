    ...
    <div class="box-body">
         <div class="row">
             ...
             <div class="col-md-4">
                ...
                <div class="col-md-2">
                    <a href="/usergroup/create" class="btn btn-primary btn-flat">Add New User Groups </a>
                </div>
     ...
     <tbody>
       ...
       <tr>
           ...
           <td  data-title="User Name">
               <a href="/usergroup/{{$c->user_group_id}}/edit/" title="Edit">
                 {{$c->user_group_name}} 
               </a>
           </td>
                     
           <td>
              <a href="/usergroup/{{$c->user_group_id}}/edit/" title="Edit"><i class="fa fa-pencil-square fa-lg"></i>&nbsp;Edit</a>
