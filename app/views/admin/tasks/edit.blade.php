...
<div class="row">
    <form  role="form" action='/tasks/{{$task->booking_task_id}}' name='user_form' id='user_form' method="post">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select id="assign_to" name="assign_to" class="form-control">
                                ...
                                <option {{$c->id==$task->booking_task_id?'selected="selected"':''}} value="{{$c->id}}">{{$c->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
