     ...
     <tbody>
       ...
       <tr>
           <td  data-title="Select">
               <input type="checkbox" class="check" name="cid[]" value="{{$l->task_id}}" id="cid{{$l->task_id}}" />
           </td>

           <td  data-title="Task Name">
               <a href="/task/{{$l->task_id}}/edit/" title="Edit">
           ...
           <td>
            ...
            <td>
              ...
              <td>
                  <a href="/newTaskComment/{{$l->task_id}}"><i class="fa fa-comment"></i>  Comments ({{TaskComment::where('task_id',$l->task_id)->get()->count()}}) </a>
           </td>
          
           <td>
              <a href="/task/{{$l->task_id}}/edit/" title="Edit"><i class="fa fa-pencil-square fa-lg"></i>&nbsp;Edit</a>
