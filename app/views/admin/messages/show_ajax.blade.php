...
<div class="row">
                  ...
                  <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-12" style="font-family:Tahoma ">
                            <?php echo  $content = str_replace('?','',$message->content); ?>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                          &nbsp;
                            ...
                            <div class="row">
                                <div class="col-md-12" style="font-family:Tahoma ">
                                                                <?php echo  $content = str_replace('?','',$m->content); ?>
        ...
        @endif
             ...
             <form  role="form" action='/messages' name='message_form' id='message_form' method="post">
                        ...
                        <input type="hidden" name="sender_page" value="ajax">
