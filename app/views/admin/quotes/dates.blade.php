...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
            ...
            <li class="active"><a href="/quotes/dates/{{$quote->quote_id}}">Dates</a></li>
...
<div class="row">
    <form  role="form" action='/quotes/saveDates' name='quote_form' id='quote_form' method="post">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                   <input type="text" name="number_of_days" id="number_of_days" value="{{Input::old('date_from',$quote->number_of_days)}}" class="form-control" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" name="date_from" id="date_from" value="{{Input::old('date_from',ZnUtilities::format_date($quote->date_from,'2'))}}"  class="form-control"/>
                                </div>
                            </div>
                        </div>
                    </div>
