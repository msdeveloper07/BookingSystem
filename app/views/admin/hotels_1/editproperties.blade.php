                      ...
                      <?php $hotel_feature = HotelFeature::where('hotel_id',$hotel->hotel_id)->pluck('supplier_type_item_id');   ?>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" class="" {{$v==$f->name?'checked="checked"':''}} @endforeach   id="hotel_name" name="property[{{$s->supplier_type_item_id}}][{{$k}}][name]" class="form-inline"  value="{{$v}}">&nbsp; {{$v}}</input>
