...
<div class="row">
    <form  role="form" action='/suppliertype/saveitems' name='supplier_type_form' id='supplier_type_form' method="post">
        <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
        <input type="hidden" name="supplier_sub_type_id" value="{{$supplier_sub_type_id}}">
