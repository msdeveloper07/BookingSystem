             ...
             <div class="col-md-4">
                     ...
                     <div class="form-group">
                        <select id="bulk_action" name="bulk_action" class="form-control" placeholder="Select Action"  >
                            ...
                            <option value="delete">Delete Selected Supplier Type Items</option>
                        </select>
                     </div>
    ...
    <thead>
     ...
     <tbody>
       ...
       <tr>
           ...
           @if(empty($c->supSubType->supplier_type))
           <td>
         {{isset($c->suptype->supplier_type)?$c->suptype->supplier_type:''}} 
       ...
       @else
        <td>{{isset($c->supSubType->supplier_type)?$c->supSubType->supplier_type:''}}</td>
           <td>
               {{isset($c->suptype->supplier_type)?$c->suptype->supplier_type:''}}
           </td>
           @endif
