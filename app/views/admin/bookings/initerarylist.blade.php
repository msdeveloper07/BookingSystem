        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
               <li ><a href="/bookings/{{$booking->booking_id}}/edit">General</a></li>
                ...
                <li class="active"><a href="/bookings/itinerary/{{$booking->booking_id}}">Itinerary</a></li>
...
<div class="row">
    <div class="col-md-8">
        <form  role="form" action='/bookings/items/{{$package->package_id}}' name='package_form' id='package_form' method="post">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                        ...
                        <div class="col-md-12">
                           <a href="/bookings/itinerary/remove/{{$l->booking_itinerary_id}}" title="Edit"><i class="fa fa-pencil-square fa-lg"></i>&nbsp;Remove</a>
    ...
    <div class="col-md-4">
        ...
        <div class="row">
            <form  role="form" action='/bookings/saveItinerary' name='itinerary_form' id='itinerary_form' method="post">
                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
