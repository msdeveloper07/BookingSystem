...
<div class="row">
    <div class="col-md-6">
    <form  role="form" action='/bookings/updatetasks/{{$booking->booking_id}}/{{$tasks->booking_task_id}}' name='user_form' id='user_form' method="post">
                 ...
                 <div class="box-body">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Enter Task" id="task_title" name="task_title" class="form-control required" value="{{$tasks->task_title}}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <textarea placeholder="Enter Task Description" id="task_description" name="task_description" class="form-control required" value="">{{$tasks->task_description}}</textarea>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select id="assign_to" name="assign_to" class="form-control">
                                ...
                                <option {{$c->id==$tasks->assign_to?'selected="selected"':''}} value="{{$c->id}}">{{$c->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
...
<!--                        <div class="col-md-4">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text"  id="due_date" name="due_date" class="form-control" value="{{$tasks->due_date}}">
                            </div>
                        </div>
                          </div>
...
<div class="col-md-12">
<div class="row">
    <form  role="form" action='/bookings/tasks/savecomment/{{$booking->booking_id}}/{{$tasks->booking_task_id}}' name='user_form' id='user_form' method="post">
        <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <select id="task_status" name="task_status" class="form-control">
                            <option {{$task_status=='Open'?'selected="selected"':''}} value="Open"> Open</option>
                            <option {{$task_status=='InProgress'?'selected="selected"':''}} value="InProgress">In Progress</option>
                            <option {{$task_status=='Closed'?'selected="selected"':''}} value="Closed"> Closed</option>
