        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
               ...
               <li ><a href="/bookings/{{$booking->booking_id}}/edit">Edit</a></li>
                ...
                <li class="active"><a href="/bookings/suppliers/{{$booking->booking_id}}">Suppliers</a></li>
...
<div class="row">
    <form  role="form" action='/bookings/savesuppliers/{{$booking->booking_id}}' name='booking_supplier_form' id='booking_supplier_form' method="post">
                ...
                <div class="box-header">
                 ...
                 <div class="box-body" >
                    ...
                    <div id="box_body1">
                        ...
                        {
                         ?>  
                        @foreach($booking_suppliers as $p)
